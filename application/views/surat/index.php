...
<!--										<td>--><?//= $value['surat_nomoragenda'] ?><!--</td>-->
										...
										<td>
											<a href="<?= base_url('assets/upload/upload_gambar/' . $value['surat_foto']) ?>" style="width: 110px"
											...
											if ($this->session->userdata('session_level') == 'PTSP'):
												if ($value['surat_disposisi'] == null):
													...
													<a href="<?= base_url('surat/edit/' . $value['surat_id']) ?>" style="width: 110px"
													   class="btn btn-small btn-success" title="Edit"><i
															class="fa fa-pencil"></i>Edit</a>
													</br>
													</br>
													<a href="<?= base_url('surat/hapus/' . $value['surat_id']) ?>" style="width: 110px"
											...
											elseif ($this->session->userdata('session_level') == 'Kepala'):
												if ($value['surat_disposisi'] == null):
													...
													<a href="<?= base_url('surat/disposisi/' . $value['surat_id']) ?>"
													   class="btn btn-small btn-success " title="Setuju" style="width: 110px"
													   onclick="return confirm('Silahkan Isi Form Disposisi')"><i
															class="fa fa-check"></i>Disposisi</a>
													</br>
													</br>
													...
													<a href="<?= base_url('surat/simpan_surat/' . $value['surat_id']) ?>" style="width: 110px"
									...
									if ($this->session->userdata('session_level') == $value['surat_tujuan_disposisi']):
										...
										<tr><td><?= $no ?></td>
											...
											<td>
												...
												<a href="<?= base_url('surat_keluar/create/' . $value['surat_id']) ?>" style="width: 110px"
												   class="btn btn-small btn-success" title="Balas"><i
														class="fa fa-send-o"></i>Balas</a>
												<?php
												if ($this->session->userdata('session_level') == 'PTSP'):
													if ($value['surat_disposisi'] == null):
														?>
												...
												elseif ($this->session->userdata('session_level') == 'Kepala'):
													if ($value['surat_disposisi'] == null):
														?>
														<a href="<?= base_url('surat/disposisi/' . $value['surat_id']) ?>" style="width: 110px"
														   class="btn btn-small btn-success " title="Setuju"
														   onclick="return confirm('Silahkan Isi Form Disposisi')"><i
																class="fa fa-check"></i>Disposisi</a>
														</br>
														</br>
														<a href="<?= base_url('surat/tolak_surat/' . $value['surat_id']) ?>" style="width: 110px"
														   class="btn btn-small btn-danger"
														   onclick="return confirm('Apakah anda yakin menolak surat ini?')"
														   title="Ditolak"><i class="fa fa-times"></i>Tolak</a>
														</br>
														</br>
														<a href="<?= base_url('surat/simpan_surat/' . $value['surat_id']) ?>" style="width: 110px"
														   class="btn btn-small btn-outline-primary" title="Disimpan"><i
