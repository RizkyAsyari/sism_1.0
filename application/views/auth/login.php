				...
				<div class="row w-100">
					<div class="col-lg-4 mx-auto">
						...
						<div class="auth-form-dark text-left p-5" style="border-radius: 35px">
							<h2><p align="center" style="font-size: 30px">Sistem Informasi Surat Menyurat</p></h2>
							<p align="center"><img src="assets/images/auth/kementerianagama_logo.png" style="width: 45%"></p>
							<h4 class="font-weight-light" align="center">Kementerian Agama Kota Payakumbuh</h4>
